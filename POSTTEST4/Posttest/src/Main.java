...
public class Main {
    ...
    private static void tambahData() throws IOException {
        ...
        System.out.println("3. Rodenstisida");
        System.out.println("4. Herbisida");
        ...
        Pestisida pestisida = new Pestisida(nama, bentukFisik, golongan, jenis);

        // Set nilai target
        clear();
        System.out.print("Target Pestisida: ");
        String target = input.readLine();
        pestisida.setTarget(target);
    ...
    private static void lihatData() throws IOException {
        ...
        for (int i = 0; i < dataPestisida.size(); i++) {
            ...
            System.out.println("Target: " + pestisida.getTarget()); // Menampilkan nilai target
            System.out.println();
        }
        System.out.print("Tekan enter untuk kembali ke menu utama...");
        input.readLine();
